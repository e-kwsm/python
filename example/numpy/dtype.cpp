...
/**
 *  @brief An example to show how to create ndarrays with built-in python data
 * types, and extract the types and values of member variables
 *
...
int main(int argc, char **argv) {
  ...
  // First create a tuple with a variable name and its dtype, double, to create
  // a custom dtype
  p::tuple for_custom_dtype = p::make_tuple("ha", dtype);
  // The list needs to be created, because the constructor to create the custom
  // dtype takes a list of (variable,variable_type) as an argument
