...
typedef std::function<bool(exception_handler const&, std::function<void(void)> const&)> handler_function;
...
struct BOOST_PYTHON_DECL exception_handler
{
 ...
 public:
    ...
    inline bool handle(std::function<void(void)> const& f) const;
    
    bool operator()(std::function<void(void)> const& f) const;
...
inline bool exception_handler::handle(std::function<void(void)> const& f) const
{
