...
rvalue_result_from_python(PyObject *src, rvalue_from_python_stage1_data &data) {
...
BOOST_PYTHON_DECL void
throw_no_pointer_from_python(PyObject *source, registration const &converters) {
...
BOOST_PYTHON_DECL void *
reference_result_from_python(PyObject *source, registration const &converters) {
