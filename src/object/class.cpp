...
extern "C"
{
  ...
  {
      PyObject *get = BOOST_NULLPTR, *set = BOOST_NULLPTR, *del = BOOST_NULLPTR, *doc = BOOST_NULLPTR;
      static const char *kwlist[] = {"fget", "fset", "fdel", "doc", BOOST_NULLPTR};
  ...
  static_data_descr_set(PyObject *self, PyObject * /*obj*/, PyObject *value)
  {
      ...
      if (value == BOOST_NULLPTR)
          func = gs->prop_del;
      else
          func = gs->prop_set;
      if (func == BOOST_NULLPTR) {
...
static PyTypeObject static_data_object = {
    ...
    BOOST_NULLPTR, //&PyProperty_Type,      /* tp_base */
    ...
    BOOST_NULLPTR, // filled in with type_new           /* tp_new */
    BOOST_NULLPTR, // filled in with __PyObject_GC_Del  /* tp_free */
...
namespace objects
{
  ...
  {
      if (static_data_object.tp_dict == BOOST_NULLPTR)
      {
...
extern "C"
{
    ...
    class_setattro(PyObject *obj, PyObject *name, PyObject* value)
    {
        ...
        if (a != BOOST_NULLPTR && PyObject_IsInstance(a, objects::static_data()))
...
static PyTypeObject class_metatype_object = {
    ...
    BOOST_NULLPTR,                          /* tp_members */
    BOOST_NULLPTR,                          /* tp_getset */
    BOOST_NULLPTR, //&PyType_Type,          /* tp_base */
    BOOST_NULLPTR,                          /* tp_dict */
...
// Get the metatype object for all extension classes.
  ...
  {
      if (class_metatype_object.tp_dict == BOOST_NULLPTR)
      {
  ...
  extern "C"
  {
      static void instance_dealloc(PyObject* inst)
      {
          ...
          for (instance_holder* p = kill_me->objects, *next; p != BOOST_NULLPTR; p = next)
          {
              next = p->next();
          ...
          // weakrefs ourselves.
          if (kill_me->weakrefs != BOOST_NULLPTR)
  ...
  static PyGetSetDef instance_getsets[] = {
      {const_cast<char*>("__dict__"),  instance_get_dict,  instance_set_dict, BOOST_NULLPTR, BOOST_NULLPTR},
      {BOOST_NULLPTR, BOOST_NULLPTR, BOOST_NULLPTR, BOOST_NULLPTR, BOOST_NULLPTR}
  };

  
  static PyMemberDef instance_members[] = {
      {const_cast<char*>("__weakref__"), T_OBJECT, offsetof(instance<>, weakrefs), 0, BOOST_NULLPTR},
  ...
  static PyTypeObject class_type_object = {
      ...
      BOOST_NULLPTR, //&PyBaseObject_Type,    /* tp_base */
      BOOST_NULLPTR,                          /* tp_dict */
      BOOST_NULLPTR,                          /* tp_descr_get */
      BOOST_NULLPTR,                          /* tp_descr_set */
  ...
  {
      if (class_type_object.tp_dict == BOOST_NULLPTR)
      {
...
//          class_type_object.tp_setattro = class_setattro;
  ...
  find_instance_impl(PyObject* inst, type_info type, bool null_shared_ptr_only)
  {
      ...
      for (instance_holder* match = self->objects; match != BOOST_NULLPTR; match = match->next())
      {
  ...
  namespace
  {
    ...
    inline type_handle query_class(type_info id)
    {
        ...
        return type_handle(
            python::borrowed(
                python::allow_null(p ? p->m_class_object : BOOST_NULLPTR))
            );
    }
    ...
    char const* name, object const& fget, char const* docstr)
  {
      object property(
          ...
          PyObject_CallFunction((PyObject*)&PyProperty_Type, const_cast<char*>("Osss"), fget.ptr(), (char*)BOOST_NULLPTR, (char*)BOOST_NULLPTR, docstr));
    ...
    char const* name, object const& fget, object const& fset, char const* docstr)
  {
      object property(
          (python::detail::new_reference)
          PyObject_CallFunction((PyObject*)&PyProperty_Type, const_cast<char*>("OOss"), fget.ptr(), fset.ptr(), (char*)BOOST_NULLPTR, docstr));
