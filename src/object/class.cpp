...
//          class_type_object.tp_setattro = class_setattro;
  ...
  {
      object property(
          reinterpret_cast<python::detail::new_reference>(PyObject_CallFunction(reinterpret_cast<PyObject*>(&PyProperty_Type), const_cast<char*>("Osss"), fget.ptr(), (char*)NULL, (char*)NULL, docstr)));
  ...
  {
      object property(
          reinterpret_cast<python::detail::new_reference>(PyObject_CallFunction(reinterpret_cast<PyObject*>(&PyProperty_Type), const_cast<char*>("OOss"), fget.ptr(), fset.ptr(), (char*)NULL, docstr)));
  ...
  {
      object property(
          reinterpret_cast<python::detail::new_reference>(PyObject_CallFunction(static_data(), const_cast<char*>("O"), fget.ptr()))
          );
  ...
  {
      object property(
          reinterpret_cast<python::detail::new_reference>(PyObject_CallFunction(static_data(), const_cast<char*>("OO"), fget.ptr(), fset.ptr())));
