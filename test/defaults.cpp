...
BOOST_PYTHON_MODULE(defaults_ext)
{
    ...
    def("bar", (object(*)(int, char, std::string, double))BOOST_NULLPTR, bar_stubs());
    ...
    class_<X>("X",no_init)
        ...
        .def("foo", (object(X::*)(std::string, bool) const)BOOST_NULLPTR, X_foo_2_stubs())
        .def("foo", (object(X::*)(int, bool) const)BOOST_NULLPTR, X_foo_2_stubs())
        .def("foo", (object(X::*)(list, list, bool) const)BOOST_NULLPTR, X_foo_3_stubs())
        ;
}
