...
namespace python {
// specialization
template <> struct has_back_reference<BR> : mpl::true_ {};
} // namespace python
} // namespace boost
...
void assert_holder(T * = 0, Held * = 0, Holder * = 0) {
  ...
  typedef
      typename class_metadata<T, Held, not_specified, not_specified>::holder h;

  assert_same<Holder>((h *)0);
}
...
int test_main(int, char *[]) {
  ...
  assert_holder<Base, Derived, value_holder_back_reference<Base, Derived>>();
